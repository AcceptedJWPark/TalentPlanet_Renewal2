...
import com.accepted.acceptedtalentplanet.AddCategory.MainActivity_AddCategory;
import com.accepted.acceptedtalentplanet.Classes.TalentObject_Home;
import com.accepted.acceptedtalentplanet.FriendList.MainActivity_Friend;
...
import com.accepted.acceptedtalentplanet.AddCategory.MainActivity_AddCategory;
import com.accepted.acceptedtalentplanet.Classes.TalentObject_Home;
import com.accepted.acceptedtalentplanet.Cs.MainActivity_Cs;
import com.accepted.acceptedtalentplanet.FriendList.MainActivity_Friend;
import com.accepted.acceptedtalentplanet.MySQLiteOpenHelper;
import com.accepted.acceptedtalentplanet.Profile.MainActivity_Profile;
...
//        Collections.shuffle(arrTalent, new Random(seed));
    ...
    private void drawerlayoutEvent(final Context context)
    {
        ...
        ((LinearLayout)findViewById(R.id.ll_claim_dl)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                dl.closeDrawers();
                Intent intent = new Intent(context, com.accepted.acceptedtalentplanet.Cs.Claim.MainActivity.class);
                startActivity(intent);
            }
        });
        ...
        ((LinearLayout)findViewById(R.id.ll_message_dl)).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mContext, com.accepted.acceptedtalentplanet.Messanger.List.MainActivity.class);
                startActivity(intent);
            }
        });
